...
\item Action: Entered "interviews-months-lack-food <- interviews %>% separate-rows(months_lack_food, sep=";") %>% mutate(months-lack-food-logical  = TRUE) %>% spread(key = months-lack_food, value = months-lack_food-logical, fill = FALSE)
